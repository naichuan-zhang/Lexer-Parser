...
{
       0,     0,     3,     9,    10,    13,    17,    18,    21,    23,
      25,    27,    29,    31,    33,    36,    39,    43,    46,    50,
      53,    56,    60,    66,    72,    78,    84,    89
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      20,     0,    -1,     5,    21,     7,    23,     6,    -1,    -1,
      22,    21,    -1,    16,    15,     3,    -1,    -1,    24,    23,
      -1,    25,    -1,    27,    -1,    29,    -1,    30,    -1,    31,
      -1,    32,    -1,     8,    26,    -1,    17,     3,    -1,    17,
       4,    26,    -1,    15,     3,    -1,    15,     4,    26,    -1,
      11,    28,    -1,    15,     3,    -1,    15,     4,    28,    -1,
       9,    18,    10,    15,     3,    -1,     9,    15,    10,    15,
       3,    -1,    14,    18,    10,    15,     3,    -1,    14,    15,
      10,    15,     3,    -1,    15,    12,    15,     3,    -1,    15,
      13,    18,     3,    -1
};
...
{
       0,    49,    49,    54,    55,    61,    66,    67,    73,    76,
      79,    82,    85,    88,    94,    98,    99,   100,   103,   109,
     113,   116,   122,   126,   134,   138,   146,   154
};
#endif
...
{
  "$end", "error", "$undefined", "DOT", "SEMICOLON", "START", "END",
  "MAIN", "PRINT", "ADD", "TO", "INPUT", "EQUALSTO", "EQUALSTOVALUE",
  "MOVE", "IDENTIFIER", "DOUBLE", "STRING", "DOUBLEVALUE", "$accept",
  "program", "declarations", "declaration", "stmts", "stmt", "printstmt",
  "printcontent", "inputstmt", "inputcontent", "addstmt", "movestmt",
  "equalstostmt", "equalstovaluestmt", 0
};
#endif
...
static const yytype_uint8 yydefact[] =
{
      ...
      19,     0,     0,     0,     0,     2,     7,    17,     0,    15,
       0,     0,     0,    20,     0,     0,     0,     0,     0,    18,
      16,     0,     0,    21,     0,     0,    26,    27,    23,    22,
      25,    24
};
...
{
      -1,    -2,     9,    10,    20,    -2,   -26,    21,    -8,   -26,
     -26,    -5,   -13,    11,    -7,     4,    22,    -8,   -26,   -26,
     -26,   -26,   -26,   -26,    15,    17,   -26,    23,    24,    19,
     -26,    25,    26,    14,    12,   -26,   -26,   -26,    -5,   -26,
      -5,    16,    27,   -26,    11,    28,    29,    34,    35,   -26,
     -26,    36,    37,   -26,    38,    42,   -26,   -26,   -26,   -26,
     -26,   -26
};
...
{
      11,    12,    27,    13,     1,    28,    14,    15,    31,     6,
      24,    32,    25,    49,     3,    50,    33,    34,    37,    38,
      39,    40,    43,    44,    10,     7,    29,     8,    35,    47,
      48,    51,    53,    41,    42,    45,    46,    56,    57,    58,
      59,    60,    52,    54,    55,    61,     9,    36
};

static const yytype_uint8 yycheck[] =
{
       8,     9,    15,    11,     5,    18,    14,    15,    15,     0,
      15,    18,    17,    38,    16,    40,    12,    13,     3,     4,
       3,     4,     3,     4,     3,    15,    15,     7,     6,    15,
      18,    15,    44,    10,    10,    10,    10,     3,     3,     3,
       3,     3,    15,    15,    15,     3,     5,    17
};
...
{
       0,     5,    20,    16,    21,    22,     0,    15,     7,    21,
       3,     8,     9,    11,    14,    15,    23,    24,    25,    27,
      29,    30,    31,    32,    15,    17,    26,    15,    18,    15,
      28,    15,    18,    12,    13,     6,    23,     3,     4,     3,
       4,    10,    10,     3,     4,    10,    10,    15,    18,    26,
      26,    15,    15,    28,    15,    15,     3,     3,     3,     3,
       3,     3
};
...
#line 61 "parser.y"
    {
		addDeclaration((yyvsp[(1) - (3)].sval), (yyvsp[(2) - (3)].sval));
	;}
    break;
...
#line 100 "parser.y"
    {
		checkIdentifier((yyvsp[(1) - (2)].sval));
	;}
    break;
...
#line 103 "parser.y"
    {
		checkIdentifier((yyvsp[(1) - (3)].sval));
	;}
    break;
...
#line 122 "parser.y"
    {
		checkIdentifier((yyvsp[(4) - (5)].sval));
		checkDoubleIdCapacity((yyvsp[(2) - (5)].sval), (yyvsp[(4) - (5)].sval));
	;}
    break;
...
#line 126 "parser.y"
    {
		checkIdentifier((yyvsp[(2) - (5)].sval));
		checkIdentifier((yyvsp[(4) - (5)].sval));
		checkIdIdCapacity((yyvsp[(2) - (5)].sval), (yyvsp[(4) - (5)].sval));
	;}
    break;
...
#line 146 "parser.y"
    {
		checkIdentifier((yyvsp[(1) - (4)].sval));
		checkIdentifier((yyvsp[(3) - (4)].sval));
		checkIdIdCapacityEqualsTo((yyvsp[(1) - (4)].sval), (yyvsp[(3) - (4)].sval));
	;}
    break;
